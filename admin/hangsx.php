...
<div class="container">
<a href="themhang.php">Thêm Hãng Sản Xuất</a>
 <div class="row">
                    <div class="col-lg-12">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        ?>
                            <tr class="odd gradeX" align="center">
                                ...
                                <td>{{tenhang}}</td>
                                 <td>{{tendanhmuc}}</td>
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="xoahang.php?id={{id}}"> Delete</a></td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="suahang.php?id={{id}}">Edit</a></td>
                            </tr>
                            <?php
                           $s = ob_get_clean();
                            $s = str_replace("{{id}}",$row_hang["id"],$s);
                           $s = str_replace("{{tenhang}}",$row_hang["tenhang"],$s);
                            $s = str_replace("{{tendanhmuc}}",$row_hang["tendanhmuc"],$s);
                            echo $s;
                                }
                            ?>
                        </tbody>
