...
<a href="themad.php">Thêm ADMIN</a>
 <div class="row">
                    <div class="col-lg-12">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        ?>
                            ...
                            <tr class="odd gradeX" align="center">
                                ...
                                <td>{{diachi}}</td>
                                <td>{{email}}</td>
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="xoaad.php?id={{id}}"> Delete</a></td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="suaad.php?id={{id}}">Edit</a></td>
                            </tr>
                           <?php
                            $s = ob_get_clean();

                            $s = str_replace("{{id}}",$row_ad["id"],$s);
                            $s = str_replace("{{hoten}}",$row_ad["hoten"],$s);
                            $s = str_replace("{{namsinh}}",$row_ad["namsinh"],$s);
